...
module.exports = {
    ...
    module: { // 用来配置非js文件对应的loader
        rules: [ // 非js文件和loader之间的对应关系
            ...
            {test: /\.(png|gif|jpeg|jpg|webp)$/, use: ['url-loader?limit=2353&esModule=false&name=[hash:5][name].[ext]']},
            // 新版本会把img src路劲处理为【object Modules】
            
            // {test: /\.(png|gif|jpeg|jpg|webp)$/, use: [
            //     {
            //         // file-loader也可以
            //         loader: 'url-loader',
            //         options: {
            //             esModule: false, // 这里设置为false，默认是true
            //         }
            //     }
            // ]},        
